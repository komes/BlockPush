...
public class PushBlock extends JavaPlugin{
      ...
      private final PushBlockPlayerListener playerListener = new PushBlockPlayerListener(this);
      //Links the BasicBlockListener
  private final PushBlockBlockListener blockListener = new PushBlockBlockListener(this);
  ...
  private final HashMap<Player, Boolean> debugees = new HashMap<Player, Boolean>();
      ...
      public PushBlock(PluginLoader pluginLoader, Server instance, PluginDescriptionFile desc, File folder, File plugin, ClassLoader cLoader)
  {
